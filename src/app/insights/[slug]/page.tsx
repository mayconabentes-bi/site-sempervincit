...
export async function generateMetadata(
  ...
  if (!post) {
    return {
      title: 'Artigo não encontrado | Semper Vincit',
    };
  }
  ...
  return {
    ...
    openGraph: {
      ...
      type: 'article',
      url: `https://www.sempervincit.com.br/insights/${post.slug}`,
    },
      ...
      <main className="pt-24 pb-20">
        ...
        <div className="container mx-auto px-4 max-w-4xl mb-12">
          ...
          <div className="flex items-center justify-between py-6 border-y border-border">
            ...
            <Button variant="outline" size="icon" className="rounded-full text-muted-foreground hover:text-primary" title="Compartilhar">
