          ...
          <div className="container mx-auto px-4 relative">
            ...
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-6xl font-bold mb-4">
                ...
                <span className="text-secondary text-gradient">Embarcações</span>
              </h2>
