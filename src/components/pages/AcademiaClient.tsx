      ...
      <main className="pt-20">
        ...
        <section className="relative py-32 overflow-hidden">
          ...
          <div className="absolute inset-0">
            <div className="absolute top-20 left-20 w-96 h-96 bg-secondary/20 rounded-full blur-3xl opacity-60" />
            <div className="absolute bottom-20 right-20 w-72 h-72 bg-white/5 rounded-full blur-3xl opacity-40" />
          </div>
        ...
        <section className="py-24 relative overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="relative rounded-3xl bg-gradient-to-br from-primary to-primary/80 p-12 md:p-16 overflow-hidden">
              <div className="absolute inset-0">
                <div className="absolute top-0 right-0 w-96 h-96 bg-secondary/20 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2 opacity-60" />
              </div>
