      ...
      <main className="pt-20">
        ...
        <section className="py-16 bg-primary text-white relative overflow-hidden">
          <div className="absolute inset-0">
            <div className="absolute top-10 left-10 w-72 h-72 bg-secondary/15 rounded-full blur-3xl shadow-lg" />
            <div className="absolute bottom-10 right-10 w-96 h-96 bg-white/5 rounded-full blur-3xl shadow-lg" />
          </div>
        ...
        <section className="py-24 bg-primary text-white relative overflow-hidden">
          <div className="absolute inset-0">
            <div className="absolute top-20 left-20 w-72 h-72 bg-secondary/20 rounded-full blur-3xl shadow-lg" />
            <div className="absolute bottom-20 right-20 w-96 h-96 bg-white/5 rounded-full blur-3xl shadow-lg" />
          </div>
          <div className="container mx-auto px-4 relative">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  <Link href="/cases">Ver Projetos Realizados</Link>
                </Button>
              </div>
            </div>
          </div>
