      ...
      <main className="pt-20">
        ...
        <section className="py-20 bg-black text-white relative overflow-hidden">
          ...
          <div className="absolute inset-0">
            <div className="absolute top-20 left-20 w-72 h-72 bg-secondary/15 rounded-full blur-3xl" />
              ...
              {[
                ...
                <div 
                  ...
                  className={`rounded-2xl p-8 transition-all duration-300 transform hover:-translate-y-2 ${
                    cable.featured 
                      ? 'bg-secondary scale-105 shadow-2xl text-white' 
...
export default CabeamentoClient;